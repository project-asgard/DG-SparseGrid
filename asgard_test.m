...
[err, act_f, act_frs] = asgard(fokkerplanck2_6p1_withLHS, 'quiet',true,'implicit',true,'lev',4,'deg',4,'num_steps',2, 'dt', 0.01, 'implicit_method', 'BDF2');

[err1, acf_f1, act_frs1] = asgard(fokkerplanck2_6p1_withLHS, 'quiet',true,'implicit',true,'lev',4,'deg',4,'num_steps',4, 'dt', 0.005, 'implicit_method', 'BDF2');

[err2, act_f2, act_frs2] = asgard(fokkerplanck2_6p1_withLHS, 'quiet',true,'implicit',true,'lev',4,'deg',4,'num_steps',8, 'dt', 0.0025, 'implicit_method', 'BDF2');
