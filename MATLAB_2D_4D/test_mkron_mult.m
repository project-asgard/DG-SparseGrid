% ----------------------------------
% simple test of mmkron_mult routines
% ----------------------------------
nerrors = 0;
nvec = 3;
Acell{1} = rand(2,3);
...
for k=2:nkron,
  ...
  if (k==2),
    ...
    Ykron = mkron_mult2( Acell{1},Acell{2},X);
  elseif (k==3),
    Y = kron( Acell{1},kron(Acell{2},Acell{3}) ) * X;
    Ykron = mkron_mult3( Acell{1},Acell{2},Acell{3},X);
  elseif (k==4),
    A12 = kron( Acell{1},Acell{2} );
    A34 = kron( Acell{3},Acell{4} );
    Y = kron( A12, A34 ) * X;
    Ykron = mkron_mult4( Acell{1},Acell{2},Acell{3},Acell{4},X);
  elseif (k==5),
    A12 = kron( Acell{1},Acell{2} );
    A34 = kron( Acell{3},Acell{4} );
    Y = kron( kron(A12, A34), Acell{5} ) * X;
    Ykron = mkron_mult5( Acell{1},Acell{2},Acell{3},Acell{4},Acell{5},X);
  elseif (k == 6),
    A12 = kron( Acell{1},Acell{2} );
    A34 = kron( Acell{3},Acell{4} );
    A56 = kron( Acell{5},Acell{6} );
    Y = kron( kron(A12,A34), A56 ) * X;
    Ykron = mkron_mult6( Acell{1},Acell{2},Acell{3},Acell{4},Acell{5},Acell{6},X);
  end;
