...
\end{eqnarray}
where $E$, $C$, and $R$ are constants, and the initial and boundary conditions are given. In this case, the steady state solution is given by
\begin{eqnarray}
...
\subsubsection{Example 1}\label{Sect1-Ex1}
