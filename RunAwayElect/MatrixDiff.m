function [Mat,Mat2,Mat1] = MatrixDiff(Lev,Deg,LInt,LEnd,FunCoef)
...
Mat1 = MatrixGrad(Lev,Deg,LInt,LEnd,0,@(x)1,@(x)0,0,2);% equation for q
Mat2 = MatrixGrad(Lev,Deg,LInt,LEnd,0,FunCoef,@(x)0,2,0); % equation for f
Mat = Mat2*Mat1;
% figure;spy(Mat)
