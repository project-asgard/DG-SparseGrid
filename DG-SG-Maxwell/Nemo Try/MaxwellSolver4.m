function [Eh,Bh] = MaxwellSolver4(Lev,Deg,Hash,InvHash,Con1D,Grad1X,Grad2X,...
...
ComMat=ComMat1B+ComMat2B+ComMat3B;
MaxMat=[ComMat/(eps*mu),zero,zero,zero,ComMat1E/(eps*mu),-ComMat2E/(eps*mu);
        zero,ComMat/(eps*mu),zero,-ComMat1E/(eps*mu),zero,ComMat3E/(eps*mu);
        zero,zero,ComMat/(eps*mu),ComMat2E/(eps*mu),-ComMat3E/(eps*mu),zero;
