...
%*************************************************
[Grad1X,Grad2X] = Matrix_TI1(Lev,Deg,Lmax,FMWT_COMP_x);
...
%% Maxwell Solver
[Eh,Bh] = MaxwellSolver1(Lev,Deg,Hash,InvHash,Con1D,Grad1X,Grad2X,pde.eps,pde.mu,pde.w,dt,MaxT,b_s,E_s*cos(0),B_s*0);
sol_n=[Eh;Bh];
