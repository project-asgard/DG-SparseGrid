function [Bh,E1h,E2h] = MaxwellSolver3(Lev,Deg,Hash,InvHash,Con1D,GradX,...
                                 omega,dt,MaxT,...
                                 F_1D,E1,E2,B)%Backward Euler
%=====================================================
...
%MaxMat=-[zero,Mat,zero;
        %Mat,zero,zero;
        %zero,zero,zero];
e=eigs(Mat,6,'largestabs','Tolerance',1e-3)
...
for T=1:MaxT
    ...
    b1=-F_1D.b1*sin(omega*time);
    b2=-F_1D.b2*sin(omega*time);
    [B,E1,E2] = SemiTime(-Mat,dt,B,E1,E2,b1,b2);
