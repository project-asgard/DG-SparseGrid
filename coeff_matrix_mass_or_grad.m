function [mat,mat1,mat2,mat0] = coeff_matrix_mass_or_grad(deg,t,dim,pterm,params, ...
...
for i=0:N-1
    ...
    %%
    % M // mass matrix u . v
    G1 = pterm.g(quad_xi,params,t,dat_R_quad) .* dim.jacobian(quad_xi,params,t);
    ...
    if strcmp(type,'grad')
        ...
        FCL = pterm.g(xL,params,t,dat_R_quad) .* dim.jacobian(xL,params,t);
        FCR = pterm.g(xR,params,t,dat_R_quad) .* dim.jacobian(xR,params,t);
        TraVal = [...
