function f = ProCoef2SG(LevX,Deg,Lmax,FMWT_COMP_x,FMWT_COMP_v,func)
% Projection from a given function to the sparse grids basis
% Input:: LevX Deg Lmax func
%
% Output:: coefficient vector f
