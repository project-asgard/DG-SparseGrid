function [Meval_v,v_node]=matrix_plot_1D(Lev_v,k,Lmin,Lmax,FMWT_COMP_v)
%=========================================
...
for Lv=0:nv-1
    xi_v=(( (quad_x+1)/2+Lv)*hv+Lmin); % mapping from [-1,1] to physical domain
    %---------------------------------------------
