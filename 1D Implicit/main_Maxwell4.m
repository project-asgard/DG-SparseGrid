...
%% Maxwell Solver
[Bh,E1h,E2h] = MaxwellSolver9(Lev,Deg,Hash,InvHash,Con1D,GradX,pde.w,dt,MaxT,...
    F_1D,E_1D.E1,E_1D.E2,B_1D.B*0);
sol_n=[Bh;E1h;E2h];

%% Error Estimate
time=dt*MaxT;
u_s=[B_1D.B*time;E_1D.E1;E_1D.E2];

Bs=[B_1D.B*time];E1s=[E_1D.E1];E2s=[E_1D.E2];
