...
%% Maxwell Solver
[Bh,E1h,E2h] = MaxwellSolver10(Lev,Deg,Hash,InvHash,Con1D,GradX,pde.w,dt,MaxT,...
    F_1D,E_1D.E1*0,E_1D.E2*0,B_1D.B*0);
sol_n=[Bh;E1h;E2h];

%% Error Estimate
time=dt*MaxT;
u_s=[B_1D.B*time;E_1D.E1*time;E_1D.E2*time];

Bs=[B_1D.B*time];E1s=[E_1D.E1*time];E2s=[E_1D.E2*time];
