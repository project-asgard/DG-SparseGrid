function [flops1, flops2, imethod,imem1,imem2] = flops_kron5( nrow1,ncol1, ...
                                                  nrow2,ncol2, ...
                                                  nrow3,ncol3, ...
                                                  nrow4,ncol4, ...
                                                  nrow5,ncol5)
%
% [flops1, flops2, imethod,imem1,imem2] = flops_kron5( nrow1,ncol1, ...
%                                          nrow2,ncol2, ...
%                                          nrow3,ncol3, ...
%                                          nrow4,ncol4, ...
%                                          nrow5,ncol5)
...
% -----------------------------------------------
% reshape X as (ncol2*ncol3*ncol4*ncol5) by ncol1
% -----------------------------------------------
nrow_X = (ncol2*ncol3*ncol4*ncol5);
ncol_X = ncol1;
...
[jflops1,jflops2,jmethod,jmem1,jmem2] = ...
       flops_kron4( nrow2,ncol2,   nrow3,ncol3,  nrow4,ncol4,  nrow5,ncol5);
...
%
% ------------------------------------------- 
% Ytmp is (nrow2*nrow3*nrow4*nrow5) by ncol_X;
% ------------------------------------------- 
