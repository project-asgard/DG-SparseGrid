...
pterm2 = GRAD(num_dims,g1,'',-1,'D','D',soln1,soln1,'',dV);
...
s1x = @(x,p,t) -exp(-x.^2).*(-6+4.*x.^2); % note the extra x^2 here is the jacobian
s1t = @(t,p) t.*0+1;
source1 = {s1x, s1t};
