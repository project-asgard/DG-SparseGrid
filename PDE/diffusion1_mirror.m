function pde = diffusion1_mirror(opts)
...
%
% explicit
% asgard(@diffusion1_mirror,'CFL',0.01);
%
% implicit
...
% asgard(@diffusion1_mirror,'lev',3,'deg',4,'timestep_method','BE', 'dt',0.05,'num_steps',20)
% DLG : this needs cleaning up
