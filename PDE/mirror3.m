...
% Run with
%
% asgard(@mirror3,'timestep_method','BE','case',3,'calculate_mass',false,'quiet',true);
%
% NOTES
% DLG: the calculation of the mass can be added back in once the mirror_3D
% branch has been merged in (same with the plotting)
