...
% tmp_1=repmat(tmp_1',[n2 n3 n4])
% tmp_2=repmat(tmp_2',[n1 n3 n4])
% tmp_3=repmat(tmp_3',[n1 n2 n4])
% tmp_4=repmat(tmp_4',[n1 n2 n3])
%
...
%
% key=[tmp_ix(:,1),tmp_iy(:,1),...
%      tmp_ix(:,2),tmp_iy(:,2),...
%      tmp_ix(:,3)-1,tmp_iy(:,3)-1];
