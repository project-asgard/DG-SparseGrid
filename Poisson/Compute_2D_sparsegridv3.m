...
P_s = sparse(dof_sparse,dof_sparse);
...
for sum_level=0:n
    for ix_level=0:sum_level
        ...
        if ix_level == iy_level || sum_level == n
            P_s=P_s+sparse(II,JJ,tmp,dof_sparse,dof_sparse);
        end
        ...
        for jx_level=0:ix_level-1
            ...
            if ix_level == iy_level || sum_level == n
                P_s=P_s+sparse([II,JJ],[JJ,II],[tmp',tmp'],dof_sparse,dof_sparse);
            end
