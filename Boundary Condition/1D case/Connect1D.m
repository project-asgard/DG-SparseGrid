...
%         Itemp_con=J;
        ...
        if Px==0
            ...
            Con(I,tmp_end)=1;
            Con(tmp_end,I)=1;
%             Itemp_con=[Itemp_con,tmp_end];
        elseif Px==2^max(0,Lx-1)-1
            tmp_begin=LevCell2index(Lx,0);
            Con(I,tmp_begin)=1;
            Con(tmp_begin,I)=1;
%             Itemp_con=[Itemp_con,tmp_begin];
        end
...
%             periodic boundary is connected
            ...
            Con(I,J)=1;
            Con(J,I)=1;
%             Itemp_con=[Itemp_con,J];
        end
%         Itemp_con
%         Itemp_con=unique(Itemp_con);
%         Con1D{I}=Itemp_con
