...
s_1 = a_1(:,1)*p_1/2*sqrt(1/hx);
s_2 = -a_2(:,1)*p_2/2*sqrt(1/hx);
s_3 = a_3(:,2)*p_1/2*sqrt(1/hx);
s_4 = -a_4(:,2)*p_2/2*sqrt(1/hx);
s_5 = a_5(:,3)*p_1/2*sqrt(1/hx);
s_6 = -a_6(:,3)*p_2/2*sqrt(1/hx);
