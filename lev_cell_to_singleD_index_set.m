function [index_set] = lev_cell_to_singleD_index_set( levels )
% [index_set] = lev_cell_to_singleD_index_set( levels )
...
if (Dim == 1),
  ...
  for i=1:isize(Dim),
     i1 = (i-1)*m + 1;
     i2 = i1 + m - 1;
     index_set(i1:i2,1:(Dim-1)) = lev_cell_to_singleD_index_set( levels(1:(Dim-1)) );
