...
%   also returns the number of residual replacements
%
%   Acknowledgement: Marielba Rojas is gratefully acknowledged for her advise on many
%                    aspects of this software. In particular, the interface for passing 
%                    functions for matrix operations using structures is her design.
%
